...
> **Plugin 범위 외 (Project 측에서 라우팅)**: 문서 정확도 검증(`doc-verification`), openclaw Docker 경계, Claude 설정 관리(`claude-ecosystem`), VP 코드 리뷰(`vp-review`) — Project 의 자체 CLAUDE.md / agents rules 에서 처리.
